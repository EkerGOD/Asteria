...
本文档是 Asteria / 星识 仓库根目录的代理协作规则。任何 Codex 或自动化代理在修改本仓库前，都应先阅读本文件，再阅读与任务相关的 `docs` 文档和子目录 `AGENTS.md`。
...
- `docs/MVP_TASKS.md`：适合一次 Codex session 完成的小任务拆分。
- `docs/DESKTOP_APP.md`：Tauri 和 FastAPI 本地服务协作方式。
- `docs/CODEX_WORKFLOW.md`：如何与 Codex 协作、如何报告修改和测试。
